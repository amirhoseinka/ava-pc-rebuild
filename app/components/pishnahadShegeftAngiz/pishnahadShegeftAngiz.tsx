...
const PishnahadShegeftAngiz = () => {
  swiperCore.use([Autoplay]);
  const { data, isLoading } = useGetAllProductsQuery();
  return (
    <>
      <div className="mx-2">
        <div className="flex justify-between bg-rose-500 md:text-xl container mx-auto text-white my-3 md:my-5 py-3 md:py-7 rounded-lg">
...
export default PishnahadShegeftAngiz;
